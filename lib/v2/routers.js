...
var weixinSettingsFunc = require('./weixin/settings');
...
module.exports = function (app, models) {
  ...
  // For weixin config
  app.use(skipper());
  var weixinSettings = weixinSettingsFunc.get(models.settings);
  ...
  weixinRouter.express(weixinSettings, weixinSession, app, '/weixin/api/:user');
  weixinRouter.getId = function (req, next) {
    next(req.params.user || '-1');
  };
