...
var config = {
  ...
  ip: process.env.OPENSHIFT_NODEJS_IP || env.NODE_IP || process.env.FORIM_HOST || '0.0.0.0',

  // 程序运行的端口
  port: process.env.OPENSHIFT_NODEJS_PORT || env.NODE_PORT || process.env.FORIM_PORT || 3000,
