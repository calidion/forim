...
var config = {
  ...
  name: process.env.NWF_NAME || 'Node开源全栈开者交流社区', // 社区名字
  description: process.env.NWF_DESCRIPTION || 'Node开源全栈开发者交流社区', // 社区的描述
  keywords: process.env.NWF_KEYWORDS || 'Node开源，Node微信开发，Node全栈',
  ...
  // 邮箱配置
  mail_opts: {
    host: process.env.NWF_MAIL_HOST,
    port: process.env.NWF_MAIL_PORT,
    auth: {
      user: process.env.NWF_MAIL_USER,
      pass: process.env.NWF_MAIL_PASSWORD
    }
  },
  ...
  create_post_per_day: process.env.NWF_POST_LIMIT || 10, // 每个用户一天可以发的主题数
  create_reply_per_day: process.env.NWF_REPLY_LIMIT || 100, // 每个用户一天可以发的评论数
  visit_per_day: process.env.NWF_IP_LIMIT || 1000 // 每个 ip 每天能访问的次数
};
